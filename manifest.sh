docker manifest create ctrlaltdev/certpibot:latest ctrlaltdev/certpibot:amd64-latest ctrlaltdev/certpibot:arm32v6-latest ctrlaltdev/certpibot:arm64v8-latest
...
docker manifest push ctrlaltdev/certpibot:latest